...
import org.husby.mindthegap.GapDetailContentProvider;
import org.husby.mindthegap.model.Category;
import org.husby.mindthegap.model.Gap;
import org.husby.mindthegap.model.Topic;

public class GapDetailView extends ViewPart {

	public static final String ID = "org.husby.mindthegap.views.gapdetail";
	...
	public GapDetailView() {
		listener = new ISelectionListener() {

			public void selectionChanged(IWorkbenchPart part,
					ISelection incoming) {
				System.out.println("GapDetailView.selectionChanged invoked");
				...
				if (incoming instanceof IStructuredSelection) {
					...
					if (selection.getFirstElement() instanceof Topic) {
						...
						viewer.setInput(new GapDetailContentProvider().getGaps(currentTopic));
						...
						viewer.setInput(new GapDetailContentProvider().getGaps(currentCategory));
					}
